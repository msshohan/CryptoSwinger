...
export const MARKETS: Market[] = ['Spot', 'Cross Margin', 'Isolated Margin', 'Options'];
...
export const FEES: Record<ExchangeName, Partial<Record<Market | 'Futures', FeeStructure>>> = {
  Binance: {
    Spot: { maker: 0.001, taker: 0.001 },
    Futures: { maker: 0.0002, taker: 0.0005 },
    'Cross Margin': { maker: 0.001, taker: 0.001 },
    'Isolated Margin': { maker: 0.0002, taker: 0.0005 },
